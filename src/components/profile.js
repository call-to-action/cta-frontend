...
export default class Profile extends Component {
    ...
    render() {
        ...
        <View style={{flex:1}}>
            ...
            <Image source ={require('../assets/profile.jpg')} resizeMode="stretch" style={{height:350, width:width}} />
            ...
            >
            <View style ={{}}>
            <Image source ={require('../assets/profile.jpg')} resizeMode="stretch" style={{height:100, width:100, margin:5}} />
            <Image source ={require('../assets/profile.jpg')} resizeMode="stretch" style={{height:100, width:100, margin:5}} />
            </View>
            <View style ={{}}>
            <Image source ={require('../assets/profile.jpg')} resizeMode="stretch" style={{height:100, width:100, margin:5}} />
